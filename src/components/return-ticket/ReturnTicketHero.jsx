            ...
            <div className="mt-8 pt-6 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div>
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-xs text-slate-500 font-medium">/ approx. $12 USD</span>
                </div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-2.5 w-full sm:w-auto">
                <a
                  ...
                  className="inline-flex w-full sm:w-auto items-center justify-center gap-1.5 rounded-xl border border-purple-200 bg-purple-50/70 hover:bg-purple-100/70 px-4 py-3.5 text-xs font-bold text-purple-700 transition cursor-pointer"
                >
                  <FileCheck2 size={14} />
