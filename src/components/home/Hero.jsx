      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-10 lg:grid-cols-12 items-start">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border border-orange-200 bg-orange-50 px-3.5 py-1 text-xs font-bold text-[#E6582A] shadow-2xs">
              <ShieldCheck size={14} className="text-[#E6582A]" />
              <span>Verifiable Dummy Tickets starting at just ₹299</span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3 text-[11px] sm:text-xs font-bold text-slate-700">
              <div className="flex items-center gap-1.5 sm:gap-2 rounded-xl bg-white p-2 sm:p-2.5 border border-slate-200/80 shadow-2xs">
                <CheckCircle2 size={15} className="text-emerald-600 shrink-0" />
                <span className="leading-tight">Checkable on Airline Site</span>
              </div>
              <div className="flex items-center gap-1.5 sm:gap-2 rounded-xl bg-white p-2 sm:p-2.5 border border-slate-200/80 shadow-2xs">
                <CheckCircle2 size={15} className="text-emerald-600 shrink-0" />
                <span className="leading-tight">100% Embassy Approved</span>
              </div>
              <div className="flex items-center gap-1.5 sm:gap-2 rounded-xl bg-white p-2 sm:p-2.5 border border-slate-200/80 shadow-2xs">
                <CheckCircle2 size={15} className="text-emerald-600 shrink-0" />
                <span className="leading-tight">10–30 Mins Delivery</span>
              </div>
              <div className="flex items-center gap-1.5 sm:gap-2 rounded-xl bg-white p-2 sm:p-2.5 border border-slate-200/80 shadow-2xs">
                <CheckCircle2 size={15} className="text-emerald-600 shrink-0" />
                <span className="leading-tight">Free Date Changes</span>
              </div>
            </div>

            {/* LIVE TICKET PREVIEW CARD */}
            <div className="rounded-3xl border border-slate-200 bg-white p-4 sm:p-5 shadow-card-clean">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                <div className="flex items-center gap-2">
                  <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#E6582A] text-white">
                    <Plane size={15} className="rotate-[-45deg]" />
                  </div>
                  <div>
                    <span className="text-xs font-black text-slate-900 block leading-tight">Live Reservation Sample</span>
                    <span className="text-[10px] text-slate-400 font-semibold">IATA Standard Format</span>
                  </div>
                </div>

                <div className="text-right">
                  <span className="text-[9px] font-bold text-slate-400 uppercase tracking-wider block">Booking Reference</span>
              ...
              {/* ROUTE DISPLAY */}
              <div className="my-4 rounded-2xl bg-slate-50 border border-slate-100 p-3 sm:p-3.5">
                <div className="flex items-center justify-between text-center gap-1 sm:gap-2">
                  <div className="text-left min-w-0 flex-1">
                    <span className="text-xl sm:text-2xl font-black text-slate-900">{origin}</span>
                  ...
                  <div className="flex flex-col items-center px-1 sm:px-2 shrink-0">
                    <span className="text-[8px] sm:text-[9px] font-bold text-slate-400 uppercase tracking-wider">NON-STOP</span>
                    <div className="relative my-1 w-12 sm:w-20 flex items-center justify-center">
                  ...
                  <div className="text-right min-w-0 flex-1">
                    <span className="text-xl sm:text-2xl font-black text-slate-900">{destination}</span>
              ...
              {/* DETAILS & ACTIONS */}
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 text-xs pt-2 border-t border-slate-100">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <a
                    ...
                    className="text-[11px] font-bold text-[#E6582A] hover:underline inline-flex items-center gap-0.5"
                  >
          ...
          <div id="booking" className="lg:col-span-6 scroll-mt-24">
            <div className="rounded-3xl border border-slate-200/90 bg-white p-5 sm:p-7 shadow-card-clean">
              
              {/* TOP ENGINE TABS (5 services: Flight, Hotel, Combo, Insurance, Return) */}
              <div className="flex overflow-x-auto no-scrollbar gap-1.5 p-1.5 rounded-2xl bg-slate-100/90 mb-5 sm:grid sm:grid-cols-5 sm:gap-1">
                {Object.values(serviceConfig).map((s) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative flex flex-col items-center justify-center py-2 px-2.5 sm:px-1 rounded-xl text-center transition-all cursor-pointer shrink-0 min-w-[76px] sm:min-w-0 sm:shrink ${
                        isActive
                          ? "bg-white text-slate-900 font-black shadow-sm"
                          : "text-slate-600 hover:text-slate-900 font-semibold"
                      }`}
                    >
                      <span className="text-[11px] sm:text-xs truncate max-w-full">{s.tabLabel}</span>
                      <span className={`text-[10px] font-bold ${isActive ? "text-[#EA580C]" : "text-slate-400"}`}>
                        {s.price}
                      </span>
                    </button>
                  );
