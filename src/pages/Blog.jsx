    ...
    <div className="bg-gradient-to-b from-orange-50/40 via-white to-slate-50 py-10 sm:py-14 lg:py-18">
      <div className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav aria-label="Breadcrumb" className="mb-6 flex items-center gap-2 text-xs font-semibold text-slate-500">
          ...
          <span className="font-bold text-[#E6582A]">Travel Blog & Guides</span>
        </nav>
        ...
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-2 rounded-full border border-orange-200 bg-orange-50 px-3.5 py-1 text-[11px] font-extrabold uppercase tracking-wider text-[#E6582A] shadow-xs">
            <BookOpen size={13} className="text-[#E6582A]" />
          ...
          <h1 className="mt-3.5 text-3xl font-black tracking-tight text-slate-900 sm:text-4xl lg:text-[44px] lg:leading-[1.15]">
            Travel Insights, Guides & <span className="text-[#E6582A]">Visa Tips</span>
          </h1>
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 border-b border-slate-200 pb-5">
              ...
              <button
                ...
                className={`rounded-xl px-3.5 py-1.5 text-xs font-bold transition-all cursor-pointer ${
                  selectedCategory === cat
                    ? "bg-[#E6582A] text-white shadow-xs"
          ...
          <div className="relative w-full sm:w-72">
            <input
              ...
              className="w-full rounded-xl border border-slate-200 bg-white pl-9 pr-3.5 py-2 text-xs font-semibold text-slate-800 focus:border-[#E6582A] focus:outline-none focus:ring-2 focus:ring-orange-100"
            />
            ...
            >
              <div>
                <div className="flex items-center justify-between gap-2 text-[11px] font-semibold text-slate-400">
                  <span className="rounded-md bg-orange-50 px-2 py-0.5 font-bold text-[#E6582A]">
                    {article.category}
                  </span>
              ...
              <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between text-xs">
                ...
                <span className="font-bold text-[#E6582A] flex items-center gap-1 group-hover:translate-x-0.5 transition-transform">
        ...
        {/* Bottom Banner */}
        <div className="mt-14 rounded-3xl bg-[#0F172A] p-8 text-white text-center sm:text-left sm:flex sm:items-center sm:justify-between">
          <div>
            <h3 className="text-xl font-bold">Need a reservation for your visa application?</h3>
            <p className="text-xs text-slate-300 mt-1">
              Valid flight and hotel itineraries issued with live PNR codes in 10 to 30 minutes starting at ₹299.
            </p>
          </div>
          <Link
